    ...
    >
      ...
      >
        ...
        >
          ...
          <template #cell(assigned_partner)="data">
            <div v-if="data.item.partner">
              {{ data.item.partner.name }}
            </div>
            <b-button
              v-if="data.item.role == 'bdm'"
              variant="outline-primary"
              class="btn-icon"
              size="sm"
              v-b-tooltip.hover.top="'Assign Partner'"
              @click="assignPartner(data.item)"
            >
              <span v-if="data.item.partner">Change Partner</span>
              <span v-else>Assign Partner</span>
            </b-button>
          </template>
...
export default {
  ...
  setup(_, context) {
    ...
    const isAssignPartnerActive = ref(false)
    const userId = ref('')
    ...
    const assignPartner = userList => {
      isAssignPartnerActive.value = true
      userId.value = userList.id
    }
