<template>
  <b-modal
    ...
    ref="edit-customer-popup"
    title="Edit Customer"
    :hide-footer="true"
    cancel-variant="outline-secondary"
    :visible="isEditCustomerActive"
    @close="$emit('update:is-edit-customer-active', false)"
    @hide="$emit('update:is-edit-customer-active', false)"
  >
    <validation-observer
...
export default {
  ...
  setup(props, { emit }) {
    ...
    onMounted(() => {
      ...
      phone.value.phone_number = props.customerData.phone
    ...
    watch(formData, () => {
      ...
      filterBillingCities(formData.value.billing_state)
    })

    const onSubmit = async () => {
      const data = new FormData()
      data.append('id', props.customerData.id)
  ...
  model: {
    prop: 'isEditCustomerActive',
    event: 'update:is-edit-customer-active',
  },
  props: {
